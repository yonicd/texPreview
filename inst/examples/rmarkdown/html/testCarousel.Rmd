...
bsplus::bs_carousel(id = "tabPrev", use_indicators = TRUE)%>%
  bsplus::bs_append(
          content = bsplus::bs_carousel_image(src = file.path(getwd(),fd,'testOut.png'))
        )%>%
  bsplus::bs_append(
          content = bsplus::bs_carousel_image(src = file.path(getwd(),fd,'testOut2.png'))
        ) 
