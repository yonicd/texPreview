...
vignette: >
  %\VignetteIndexEntry{Using texPreview to create Carousels in Rmarkdown}
...
The images created above are placed in a [slickR](https://github.com/yonicd/slickr) carousel.
